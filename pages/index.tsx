      ...
      <section className="body-font m-0 text-gray-600">
        ...
        <section className=" py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="animate-fadeIn mt-8 flex justify-center space-x-4">
              <a
                className="inline-flex items-center rounded-lg border border-indigo-600 bg-indigo-600 px-8 py-3 text-white transition-colors duration-300 hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500"
